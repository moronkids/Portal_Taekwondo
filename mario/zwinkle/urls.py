...
from . import views
from .views import AnggotaAutocomplete, TestModelList, TestModelListJson, IndexView
app_name = 'zwinkle'
urlpatterns = [
                  url(r'^krida/history', TestModelList.as_view(), name="collection_history"),
    ...
    # path('krida/history/', views.CollectionHistory.as_view(), name='collection_history'),
